 ...
 *******************************************************************************/
package cn.edu.bit.ruixin.doc.collector;
...
import cn.edu.bit.ruixin.doc.model.*;
...
public abstract class AbstractCollector implements Collector {
     ...
     * <p>
     * If any class contains the special javadoc tag {@link cn.edu.bit.ruixin.doc.util.TagUtils.IGNORE_TAG} it will be excluded.
     *
     * @param classDoc
     * @return
     */
     ...
     * <p>
     * If any method contains the special javadoc tag {@link cn.edu.bit.ruixin.doc.util.TagUtils.IGNORE_TAG} it will be excluded.
     *
     * @param contextPath
     * @param classMapping
     * @param method
...
//    protected Collection<Endpoint> getEndpoint(String contextPath, EndpointMapping classMapping, MethodDoc method) {
     ...
     * <p>
     * This looks for the value in a special javadoc tag {@link cn.edu.bit.ruixin.doc.util.TagUtils.CONTEXT_TAG}
     *
     * @param classDoc
     * @return
     */
     ...
     * <p>
     * This looks for the value in a special javadoc tag {@link cn.edu.bit.ruixin.doc.util.TagUtils.NAME_TAG}
     *
     * @param classDoc
     * @return
     */
